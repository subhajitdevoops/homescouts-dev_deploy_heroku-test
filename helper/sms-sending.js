YOUR_API_KEY = "cxi9QZfTOwG7aqyvpdX4J6P0ERhVe3uzFY5n2ogrjINKCDHBSW8vlYwLQygu6etkrs97b4NzAaF52ZDP";
TARGET_PHONE_NUMBER = 9836926770;

let axios = require('axios');
var fast2sms = {

    init({ API_KEY, route, sender_id, language, variable, variable_value }) {
        this.API_KEY = API_KEY || "cxi9QZfTOwG7aqyvpdX4J6P0ERhVe3uzFY5n2ogrjINKCDHBSW8vlYwLQygu6etkrs97b4NzAaF52ZDP";
        this.route = route || 'qt';
